-- Reforçando os GRANTs de forma explícita para o role 'authenticated'
-- O Data API do Supabase usa o role 'authenticated' ou 'anon'.
-- Sem GRANT, o RLS não é sequer avaliado, resultando em 'permission denied'.
