...
export default function WelcomeTour({ isDependente }: { isDependente: boolean }) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) finish(); }}>
      <DialogContent className="max-w-[420px] w-[calc(100%-32px)] max-h-[75vh] gap-0 overflow-hidden flex flex-col p-0 border-none shadow-2xl bg-card">
        ...
        <DialogFooter className="flex-row items-center justify-between gap-2 p-4 border-t bg-muted/30">
