  ...
  ({ children, className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "public-auth-theme w-full auth-card border-[var(--portal-modal-border-light)] shadow-[var(--portal-modal-shadow-light)] !bg-[var(--portal-modal-bg-light)] overflow-hidden ds-animate-slide-in-up rounded-[var(--portal-modal-radius)] mx-auto",
          className
        )}
        style={{ 
