      ...
      {services.map((s) => {
        ...
        return (
          <li key={s.id}>
            <Link
              to={s.route}
              className="flex h-full gap-3 rounded-xl border bg-card p-4 transition-colors hover:border-primary/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
  ...
  return (
    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
      {channels.map((c) => {
        const Icon = c.icon;
        return (
          <div key={c.id} className="flex items-center gap-3 rounded-xl border bg-card p-4">
